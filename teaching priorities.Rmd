...
```{r}
ggplot() + 
  geom_col(data = top_tree, aes(x = first_priority, y = count_first, fill = "red"), position = "dodge") +
  theme(axis.text.x = element_text(angle= 45, hjust = 1)) +
  geom_col(data = top_tree, aes(x = first_priority, y = count_second, fill = "blue"), position = "dodge") +
  geom_col(data = top_tree, aes(x = first_priority, y = count_third, fill = "green"), position = "dodge") 
```
